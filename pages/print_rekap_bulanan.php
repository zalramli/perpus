...
function LoadData()
{
    ...
    $query = "SELECT tgl_pinjam,nama_peminjam,nomor_induk,jabatan,program_studi,kelas_semester,judul_buku1,jumlah1,judul_buku2,jumlah2 FROM tabel_peminjaman WHERE tgl_pinjam BETWEEN '$awal_bulan' AND '$akhir_bulan'";
